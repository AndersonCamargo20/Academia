...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { ativo: @aluno.ativo, matricula: @aluno.matricula, pessoa_id: @aluno.pessoa_id } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { ativo: @aluno.ativo, matricula: @aluno.matricula, pessoa_id: @aluno.pessoa_id } }
